...
if(isset($_GET['updateid'])){
    ...
    if (isset($_POST['submit'])) {
        ...
        // Update the table
        $sql = "UPDATE Hospital_Admit SET Name='$Name', Phone='$Phone', Address='$Address', Problem='$Problem', Specialist_doctor='$Specialist_doctor', Location='$Location' WHERE Phone='$Phone'";
        $result = mysqli_query($con, $sql);
        if ($result) {
            echo "Updated successfully";
            //header("Location: display_admitdata.php"); // If updated successfully, redirect to display_admitdata.php page
            exit; // Terminate the script to prevent further execution
        } else {
            die(mysqli_error($con));
        }
    }else {
    echo "No updateid parameter provided.";
}
}
?>
...
<body>
    <div class="container">
        ...
        <form action="display_admitdata.php" method="POST">
